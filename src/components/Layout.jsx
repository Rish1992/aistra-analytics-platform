...
const navItems = [
  ...
  { type: 'divider', label: 'DEEPTALK' },
  { id: 'deeptalk', label: 'Deeptalk Overview', icon: 'ai', path: '/deeptalk' },
  { id: 'deeptalk-bots', label: 'Deeptalk Bots', icon: 'agent', path: '/deeptalk/bots' },
  { id: 'talk-deeptalk', label: 'Talk to Deeptalk', icon: 'talk', path: '/talk-to-deeptalk' },
